      ...
      <table className="w-full table-fixed">
        ...
        <thead>
          <tr className="bg-base-300">
            ...
            <th className="px-6 py-4 text-left font-semibold text-base-content w-3/12">Proposer</th>
            <th className="px-6 py-4 text-left font-semibold text-base-content w-3/12">Disputer</th>
