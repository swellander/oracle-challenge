...
export const DisputedModal = ({ assertion, isOpen, onClose }: AssertionModalProps) => {
  ...
  const handleDeciderResolve = async (outcome: boolean) => {
    try {
      setIsProposing(true);
          ...
          <div className="">
            ...
            <div className="text-center mb-6">
              <h2 className="text-lg">
                Current State: <span className="font-bold">Disputed</span>
              </h2>
            </div>
                ...
                <div className="bg-base-200 rounded-lg p-4">
                  ...
                  <div className="flex justify-center gap-4">
                    <button
                      ...
                      onClick={() => handleDeciderResolve(true)}
                    ...
                    <button
                      className="btn btn-primary flex-1"
                      onClick={() => handleDeciderResolve(false)}
                      disabled={isProposing}
                    >
                      False
                    </button>
